    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select id="cPS" class="form-control" name="PageSize" onchange="change()">
                                ...
                                <option ${productList.pageSize==i?'selected':''}>${i}</option>
                                </c:forEach>
                            </select> 条
                        </div>
                    </div>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="javascript:goPage(${productList.prePage})">上一页</a></li>
                            <c:forEach begin="${productList.navigateFirstPage}" end="${productList.navigateLastPage}" var="i">
                                <li class="paginate_button ${productList.pageNum==i ? 'active':''}"><a href="javascript:goPage(${i})">${i}</a></li>
                            </c:forEach>
                            <li><a href="javascript:goPage(${productList.nextPage})">下一页</a></li>
                            <li>
                ...
                <!-- /.box-footer-->
                <form id="pageForm" action="${pageContext.request.contextPath}/product/findAll.do" method="post">
